        ...
        success: function (data) {
            if (data) {
                ...
                Swal.fire({
                    type: 'success',
                    title: 'SUCCESS',
                    text: 'คืนอุปกรณ์แล้ว (คืนอุปกรณ์ตรงเวลาที่กำหนด)',
        ...
        success: function (data) {
            if (data) {
                ...
                Swal.fire({
                    type: 'success',
                    title: 'SUCCESS',
                    text: 'คืนอุปกรณ์แล้ว (คืนอุปกรณ์ล่าช้ากว่าเวลาที่กำหนด)',
                    confirmButtonText: '<i class="fa fa-check"></i> ตกลง',
                }).then(function () {
                    table.clear().draw();
                    RequestAppointmentTeacher(i = 1);
...
async function createExcel() {
    ...
    var worksheet = workbook.addWorksheet('เอกสารการยืม-คืน', {
    ...
    worksheet.getCell('A4').value = "เอกสารการยืม-คืนอุปกรณ์ภาควิชาวิศวกรรมคอมพิวเตอร์";
    ...
    worksheet.getCell('A6').value = "ชื่อ - นามสกุล :";
    ...
    worksheet.getCell('E6').value = "รหัสนักศึกษา :";
    ...
    worksheet.getCell('A7').value = "กลุ่มนักศึกษา :";
    ...
    worksheet.getCell('E7').value = "เบอร์โทรติดต่อ :";
    ...
    worksheet.getCell('A8').value = "นำไปใช้ในกิจกรรม :";
    ...
    worksheet.getCell('A9').value = "วันที่กำหนดส่งคืน :";
    ...
    worksheet.getCell('A10').value = "นำอุปกรณ์ส่งคืน :";
    ...
    worksheet.getCell('C10').value = "( ) ส่งคืนตรงเวลา";
    worksheet.getCell('C10').alignment = { horizontal: 'center' };

    worksheet.mergeCells('E10:I10');
    worksheet.getCell('E10').value = "( ) ส่งคืนล่าช้า  วันที่นำมาส่งคืน …........./…........./….........";
    worksheet.getCell('E10').alignment = { horizontal: 'center' };

    // Table tools
    // Header //
    worksheet.getCell('A11').value = "ลำดับ";
    ...
    worksheet.getCell('B11').value = "รายการอุปกรณ์";
    ...
    worksheet.getCell('H11').value = "จำนวน";
    ...
    worksheet.getCell('A18').value = "ข้าพเจ้าได้รับทราบกำหนดส่งคืนและอุปกรณ์ตามรายการด้านบนเรียบร้อยแล้ว";
    worksheet.getCell('A18').alignment = { horizontal: 'center' };

    // Table
    worksheet.mergeCells('A19:I19');
    worksheet.getCell('A19').value = "สำหรับการยืมเท่านั้น";
    ...
    worksheet.getCell('A20').value = "ลงชื่อ";
    ...
    worksheet.getCell('F20').value = "ลงชื่อ";
    ...
    worksheet.getCell('A23').value = "ผู้ยืมอุปกรณ์";
    ...
    worksheet.getCell('F23').value = "เจ้าหน้าที่ผู้ให้ยืมอุปกรณ์";
    ...
    worksheet.getCell('A26').value = "ข้าพเจ้าได้ส่งคืนอุปกรณ์ตามรายการด้านบนเรียบร้อยแล้ว";
    worksheet.getCell('A26').alignment = { horizontal: 'center' };

    // Table
    worksheet.mergeCells('A27:I27');
    worksheet.getCell('A27').value = "สำหรับการรับคืนเท่านั้น";
    ...
    worksheet.getCell('A28').value = "ลงชื่อ";
    ...
    worksheet.getCell('F28').value = "ลงชื่อ";
    ...
    worksheet.getCell('A31').value = "ผู้ส่งคืนอุปกรณ์";
    ...
    worksheet.getCell('F31').value = "เจ้าหน้าที่ผู้รับคืนอุปกรณ์";
    ...
    saveAs(new Blob([buf]), 'APPOINTMENT_เอกสารการยืม-คืน_' + nameStudent + '.xlsx');
}
