                    ...
                    success: function (data) {
                        if (data) {
                            if (data.allApp == 0) {
                                ...
                                $('#dash_borrowTool_value').html(data.allProcess);
                                runNumberDashboard();
...
function initListgroup(doc) {
    ...
    if (doc.status == "อนุมัติ" || doc.status == "อนุมัติ(เสร็จสิ้น)") {
        ...
        listgroup = '<div class="list-group-item list-group-item-action flex-column align-items-start" id="' + doc.note_ID + '">' +
            '<div class="d-flex w-100 justify-content-between">' +
            '<h4 class="mb-1" style="margin-top: 5px;"><b>นักศึกษาชื่อ : </b>' + doc.name + '</h4>' +
            '<small><img src="/assets/images/borrow.png"style="width: 45px; height: 45px;"></small>' +
            '</div>' +
            '<div class="row">' +
            '<div class="col-sm-12">' +
            '<div class="row mb-0" style="margin: 0px; vertical-align: middle;">' +
            ...
            '<p style="margin-left: 5px;"><b>ที่ : </b>' + doc.date + '</p>' +
            '<p style="margin-left: 5px;"><b>เวลา : </b>' + doc.time + '</p>' +
            '<p style="margin-left: 30px;"><b>สถานะการนัดหมาย : </b><span style="font-weight: bold; color: #ffea83;">กำลังยืมอุปกรณ์</span></p>' +
            '</div>' +
            '</div>' +
            '</div>' +
            '</div>';
        ...
        listgroup = '<div class="list-group-item list-group-item-action flex-column align-items-start" id="' + doc.note_ID + '">' +
            '<div class="d-flex w-100 justify-content-between">' +
            '<h4 class="mb-1" style="margin-top: 5px;"><b>นักศึกษาชื่อ : </b>' + doc.name + '</h4>' +
            '<small><img src="/assets/images/finishedborrow.png"style="width: 45px; height: 45px;"></small>' +
            '</div>' +
            '<div class="row">' +
            '<div class="col-sm-12">' +
            '<div class="row mb-0" style="margin: 0px; vertical-align: middle;">' +
            ...
            '<p style="margin-left: 5px;"><b>ที่ : </b>' + doc.date + '</p>' +
            '<p style="margin-left: 5px;"><b>เวลา : </b>' + doc.time + '</p>' +
            '<p style="margin-left: 30px;"><b>สถานะการนัดหมาย : </b><span style="font-weight: bold; color: #8ed5ff;">คืนอุปกรณ์แล้ว(ตรงเวลา)</span></p>' +
            '</div>' +
            '</div>' +
            '</div>' +
            '</div>';
        ...
        listgroup = '<div class="list-group-item list-group-item-action flex-column align-items-start" id="' + doc.note_ID + '">' +
            ...
            '<p style="margin-left: 5px;"><b>ที่ : </b>' + doc.date + '</p>' +
            '<p style="margin-left: 5px;"><b>เวลา : </b>' + doc.time + '</p>' +
            '<p style="margin-left: 30px;"><b>สถานะการนัดหมาย : </b><span style="font-weight: bold; color: #9fa5ff;">คืนอุปกรณ์แล้ว(ล่าช้า)</span></p>' +
            '</div>' +
            '</div>' +
            '</div>' +
            '</div>';
